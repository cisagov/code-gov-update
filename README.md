...
```console
docker run cisagov/code-gov-update:0.1.0
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/code-gov-update:0.1.0
    ```
...
|-----------|-------------|
|`cisagov/code-gov-update:0.1.0`| An exact release version. |
...
```console
docker build \
  --tag cisagov/code-gov-update:0.1.0 \
